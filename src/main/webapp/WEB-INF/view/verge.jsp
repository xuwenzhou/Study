...
<!--[if gt IE 8]><!--> <html class="no-js"> <!--<![endif]-->
	...
	<title>Verge &mdash; A free HTML5 Template </title>
					...
					<div class="fh5co-intro">
						<div class="row">
							<div class="col-md-8 col-md-offset-2 text-center">
								...
								<h2 class="fh5co-intro-sub animate-2 to-animate">Hi! I&acute;m John Doe, a Senior Front-End Developer currently working at </h2>
							...
							<div class="row">
								...
								<div class="col-md-3">
									...
									<ul class="fh5co-contact">
										...
										<li class="to-animate"><i class="icon-globe"></i>mail.@qq.com</li>
									</ul>
								</div>
			...
			<div class="container" id="footer-animate">
				<div class="row row-padded">
					<div class="col-md-8 col-md-push-4">
						<p class="to-animate">&copy; 2015 Free Verge. All Rights Reserved. Designed: More Templates <a href="http://www.cssmoban.com/" target="_blank" title="模板之家">模板之家</a> - Collect from <a href="http://www.cssmoban.com/" title="网页模板" target="_blank">网页模板</a></p>
						<p class="to-animate">Images: <a href="#" target="_blank">Unsplash</a> &amp; <a href="#" target="_blank">plmd.me</a></p>
					</div>
				</div>
			</div>
			<!-- END .container -->
